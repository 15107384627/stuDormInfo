...
<script type="text/javascript">
	...
	function insertOnclick() {
		...
		var sex= $("#sex").val();
		var tel = $("#tel").val();
		if(stuNum!=null&&stuNum!=""&&password!=null&&password!=""&&rpassword!=null&&rpassword!=""&&name!=null&&name!=""&&dormBuildId!=null&&dormBuildId!=""&&dormName!=null&&dormName!=""&&sex!=null&&sex!=""&&tel!=null&&tel!=""){
			...
			<div id="tab1" class="tabson">
				...
				<ul class="forminfo">
					...
					<li><label>宿舍名<b>*</b></label><input id="dormName" type="text"
						class="dfinput" placeholder="请填写宿舍名" style="width: 518px;" /></li>
