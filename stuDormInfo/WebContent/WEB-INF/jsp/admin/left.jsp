		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					<li><a href="${pageContext.request.contextPath}/adminBlank" target="rightFrame"><i class="icon-chevron-right"></i>首页</a></li>
					<li><a href="${pageContext.request.contextPath}/dormManager/info" target="rightFrame"><i class="icon-chevron-right"></i>宿舍管理员管理</a></li>
					<li><a href="${pageContext.request.contextPath}/student/info?userType=${userType}" target="rightFrame"><i class="icon-chevron-right"></i>学生管理</a></li>
					<li><a href="${pageContext.request.contextPath}/dormBuild/info" target="rightFrame"><i class="icon-chevron-right" target="rightFrame"></i>宿舍楼管理</a></li>
					<li><a href="${pageContext.request.contextPath}/record/info?userType=${userType}" target="rightFrame"><i class="icon-chevron-right" target="rightFrame"></i>缺勤记录</a></li>
					<li><a href="${pageContext.request.contextPath}/adminPasswordChange" target="rightFrame"><i class="icon-chevron-right"></i>修改密码</a></li>
