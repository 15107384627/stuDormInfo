...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div  style="height: 100px;background-image: url('${pageContext.request.contextPath}/public/images/bg.jpg')">
		...
		<div class="topright" style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<font color="red" >${userName }</font></li></ul></div>
	</div>
</div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					<li><a href="${pageContext.request.contextPath}/user/mainAdmin"><i class="icon-chevron-right"></i>首页</a></li>
					<li><a href="${pageContext.request.contextPath}/dormManager"><i class="icon-chevron-right"></i>宿舍管理员管理</a></li>
