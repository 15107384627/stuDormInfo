		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					<li><a href="${pageContext.request.contextPath}/dormManagerBlank" target="rightFrame"><i class="icon-chevron-right"></i>首页</a></li>
					<li><a href="${pageContext.request.contextPath}/student/info?userType=${userType}" target="rightFrame"><i class="icon-chevron-right"></i>学生查看</a></li>
					...
					<li><a href="${pageContext.request.contextPath}/dormManagePasswordChange" target="rightFrame"><i class="icon-chevron-right"></i>修改密码</a></li>
