...
<frameset rows="120,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="300,*" frameborder="no" border="0" framespacing="0">
    <frame src="${pageContext.request.contextPath}/studentLeft" name="leftFrame" scrolling="no" noresize="noresize" id="leftFrame" title="leftFrame" />
    <frame src="${pageContext.request.contextPath}/studentBlank" name="rightFrame" id="rightFrame" title="rightFrame" />
  </frameset>
</frameset>
<noframes><body>
</body></noframes>
